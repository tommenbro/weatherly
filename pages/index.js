  ...
  if (loading) {
    ...
    return (
      <div>
        ...
        {/* Overlay */}
        <div className="absolute top-0 left-0 right-0 bottom-0 bg-black/10 z-[1]"></div>
        {/* Background image */}
        <Image
        ...
        {/* Search */}
        <div className="relative flex justify-between items-center max-w-[360px] w-full m-auto pt-16 text-white z-10">
          <form
